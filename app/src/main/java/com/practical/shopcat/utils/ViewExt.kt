package com.practical.shopcat.utils
...
fun ImageView.loadImage(url: String) = Picasso.get().load(url).placeholder(R.mipmap.ic_launcher).error(R.drawable.ic_launcher_background).into(this)
